...
const Header: FC<HeaderProps> = ({
  ...
  return (
    <div 
      className={`relative flex flex-col items-start justify-end w-80 pt-6 pb-3 bg-[#fdf9f0] border border-solid border-[#d9c29a] rounded-b-2xl shadow-card ${className}`}
    >
