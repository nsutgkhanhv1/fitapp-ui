...
const ButtonWhite: FC<ButtonWhiteProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`relative flex items-center justify-center min-w-48 py-2 px-3 w-full rounded-full border border-solid border-card-border shadow-card ${done ? 'bg-success' : 'bg-ui-white'
          }`}
      >
